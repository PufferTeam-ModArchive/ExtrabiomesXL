 ...
 * is absent after the Init event, then the Extrabiomes mod is not active or not installed.
 * <p>
...
public abstract class BiomeManager {
     ...
     *                 function should be applied to the current total weight for a biome.
     */
