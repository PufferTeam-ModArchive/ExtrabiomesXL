...
public class BlockQuarterLog extends BlockLog {
    ...
    public void setupTextures(int index) {
        // The intention here is to maintain the old system of using texture sheet indexes to choose a texture. This is
        // because reworking these texture
    ...
    private Block getNextBlock() {
        ...
        if (this == BarkOn.SW.block) return BarkOn.NE.block;
        if (this == BarkOn.NE.block) return BarkOn.NW.block;
        if (this == BarkOn.NW.block) return BarkOn.SE.block;
    ...
    public void onUseLogTurnerEvent(UseLogTurnerEvent event) {
        ...
        if (block == this) {
            ...
            if (!event.world.isRemote) {
                ...
                if (orientation == 0) block = getNextBlock();
