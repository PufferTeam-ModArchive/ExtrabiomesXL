...
public abstract class ForestryModHelper {
    ...
    private static final List<ItemStack> backpackDigger = new ArrayList<>();
    private static final List<ItemStack> backpackForester = new ArrayList<>();
    private static final List<ItemStack> basicFlowers = new ArrayList<>();
    private static final List<ItemStack> germlings = new ArrayList<>();
    private static final List<ItemStack> leaves = new ArrayList<>();
    private static final List<ItemStack> saplings = new ArrayList<>();
    ...
    public static boolean isGermling(ItemStack stack) {
        ...
        for (final ItemStack is : germlings) if (ItemStack.areItemStacksEqual(is, stack)) return true;
        return false;
    }
    ...
    public static void registerBasicFlower(ItemStack stack) {
        ...
        // To enforce uniqueness in the List (should be a Set, but
        // ItemStack.equals() is not defined. -.-
        for (final ItemStack is : basicFlowers) if (ItemStack.areItemStacksEqual(is, stack)) return;
    ...
    public static void registerGermling(ItemStack stack) {
        ...
        // To enforce uniqueness in the List (should be a Set, but
        // ItemStack.equals() is not defined. -.-
        for (final ItemStack is : germlings) if (ItemStack.areItemStacksEqual(is, stack)) return;
    ...
    public static void registerLeaves(ItemStack stack) {
        ...
        // To enforce uniqueness in the List (should be a Set, but
        // ItemStack.equals() is not defined. -.-
        for (final ItemStack is : leaves) if (ItemStack.areItemStacksEqual(is, stack)) return;
    ...
    public static void registerSapling(ItemStack stack) {
        ...
        // To enforce uniqueness in the List (should be a Set, but
        // ItemStack.equals() is not defined. -.-
        for (final ItemStack is : saplings) if (ItemStack.areItemStacksEqual(is, stack)) return;
