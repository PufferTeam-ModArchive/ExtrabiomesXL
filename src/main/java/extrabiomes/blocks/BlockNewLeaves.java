...
public class BlockNewLeaves extends BlockLeavesBase implements IShearable {
    ...
    private void leafTypeDropper(IBlockAccess iBlockAccess, World world, int x, int y, int z, int metadata, int par7) {
        ...
        if (damageValue == BlockType.JAPANESE_MAPLE.metadata || damageValue == BlockType.JAPANESE_MAPLE_SHRUB.metadata
    ...
    public int getRenderColor(int metadata) {
        ...
        // return metadata == 0 ? ColorizerFoliage.getFoliageColorPine() : metadata == 1 ?
        // ColorizerFoliage.getFoliageColorBasic() : ColorizerFoliage.getFoliageColor(0.9F, 0.1F);
    }
    ...
    @Override
    public void harvestBlock(World world, final EntityPlayer player, final int x, final int y, final int z,
            final int md) {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        final int rangeWood = (unmarkedMetadata(metadata) == BlockType.JAPANESE_MAPLE_SHRUB.metadata) ? 2
                : (unmarkedMetadata(metadata) == BlockType.JAPANESE_MAPLE.metadata) ? 4 : 7;
                ...
                for (int var13 = -rangeWood; var13 <= rangeWood; ++var13) {
                    for (int var14 = -rangeWood; var14 <= rangeWood; ++var14) {
                        for (int var15 = -rangeWood; var15 <= rangeWood; ++var15) {
                            if (adjacentTreeBlocks[(var13 + var11) * var10 + (var14 + var11) * var9 + var15 + var11]
                                    == var12 - 1) {
