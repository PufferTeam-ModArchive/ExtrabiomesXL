...
public class EnhancedConfiguration extends Configuration {
    ...
    /**
     * Gets or create a biome id property. If the biome id property key is already in the configuration, then it will be
     * used. Otherwise, defaultId will be used, except if already taken, in which case this will try to determine a free
     * default id.
     */
